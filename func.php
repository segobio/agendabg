        ...
        ### Se a posição for 0 (zero), o jogo é cooperativo, não tem ranking (APENAS WINNERS E LOSERS)
            ...
            }else
            {
                ...
                for ($i=0; $i < $index; $i++) {
                    ...
                    if ($i == 0) {
                        ### Primeiro da lista é o vendedor e recebe a classe "winner"
                        echo "<li class='listplayer winner'><img class='h-18' src='img/p$p.png'><span class='player'>$user ($score)</li>";
                    }else{
                        ### Jogadores seguintes são listados normalmente
                        echo "<li class='listplayer'><img class='h-18' src='img/p$p.png'><span class='player'>$user ($score)</li>";
                    }                
                    $p++;
                }
            }
