...
<div class="cadastro_box">
    ...
    <form class="" method="post">
        ...
        <div class="cell"><input class="w3-input" type="text" name="mail" placeholder="e-mail" value=""></div>
        <div class="cell"><input class="w3-input" type="password" name="pass" placeholder="Senha" value=""></div>
        <div class="cell"><input class="w3-input" type="password" name="pass2" placeholder="Repetir Senha" value=""></div>
