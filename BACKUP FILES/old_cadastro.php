...
<div class="cadastro_box">
    ...
    <form class="" method="post">
        ...
        <div class="cell">
            <label>Jogo</label>
            <br>
            <input class="w3-input" type="text" name="jogo" placeholder="Nome do Jogo" value="<?php echo $row[0]; ?>" required>
        </div>
        
        <div class="cell">
            <label>Dia do evento</label>
            <br>
            <input class="w3-input" type="number" name="dia" placeholder="Dia do Evento" min="1" max="<?php echo $daysInMonth ?>" value="<?php echo $currDay; ?>" required>
        </div>
        ...
        <?php
            ...
            for ($i=$row[11]; $i>0 ; $i--) {
                if ($row[$j] != NULL) {
                    echo "<div class='cell'><label>Jogador $j</label><input class='w3-input' type='text' name='jogador$j' placeholder='Player $j' value='$row[$j]'></div>";
                    $j++;
                }else{
                    echo "<div class='cell'><label>Jogador $j</label><input class='w3-input' type='text' name='jogador$j' placeholder='Player $j' value=''></div>";
                    break;
                }
            } ?>
        ...
        <div class="cell">
            ...
            <br>
            <input class="w3-input" type="text" name="local" placeholder="Local" value="<?php echo $row[9]; ?>">
        </div>
        <div class="cell">
            <label>First Name</label>
            <input class="w3-input" type="text" name="horario" placeholder="Horario" value="<?php echo $row[10]; ?>" required>
        </div>
        <div class="cell">
            <label>Max. Jogadores</label>
            <input class="w3-input" type="text" name="slots" placeholder="Nº de jogadores" value="<?php echo $row[11]; ?>" required>
        </div>
